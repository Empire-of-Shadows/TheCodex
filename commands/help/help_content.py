...
WYR = HelpCategory(
    ...
    body=(
        ...
        "\n"
        "Questions come from a written question bank. Age-restricted questions are "
        "only ever posted in channels Discord marks as age-restricted."
    ),
)
...
ADMIN = HelpCategory(
    ...
    body=(
        ...
        "Post a question by hand, or clear one member's voting stats.\n"
        "\n"
