...
SETUP_GUIDE_TEXT = (
    ...
    "\n"
    "**1\\. Panel Access Roles**\n"
    "Give users permission to open the admin panel.\n"
    # No blank line after a bullet list - Discord's list block carries its own
    # bottom margin, and an explicit blank line stacks into a double gap.
    "- Set **Panel Access Roles** so trusted members can open this panel without "
    "Manage Server. Holders get the same full access as Manage Server.\n"
    "**2\\. Embed Settings**\n"
